...
The repository is public and now presents RemoteOps as a free voice-first computer-management product for Windows, Linux and macOS.
...
- a documented Windows adapter boundary;
...
4. Record dated public evidence for the operating-system versions that receive stable-support claims.
